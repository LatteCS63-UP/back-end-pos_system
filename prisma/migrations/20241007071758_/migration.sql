...
*/
-- DropForeignKey
ALTER TABLE `Shop` DROP FOREIGN KEY `Shop_DistrictID_fkey`;

-- DropForeignKey
ALTER TABLE `Shop` DROP FOREIGN KEY `Shop_ProvinceID_fkey`;

-- DropForeignKey
ALTER TABLE `Shop` DROP FOREIGN KEY `Shop_SubDistrictID_fkey`;
