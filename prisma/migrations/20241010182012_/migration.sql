/*
  ...
  - Added the required column `StatusLogin` to the `Owner` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `Owner` ADD COLUMN `StatusLogin` VARCHAR(1) NOT NULL,
