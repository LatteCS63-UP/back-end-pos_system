/*
  ...
  - You are about to drop the column `OwnerFirstname` on the `Owner` table. All the data in the column will be lost.
  - You are about to drop the column `OwnerLastname` on the `Owner` table. All the data in the column will be lost.
  ...
  - Added the required column `OwnerFirst_name` to the `Owner` table without a default value. This is not possible if the table is not empty.
  - Added the required column `OwnerLast_name` to the `Owner` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `MasJobTitle` MODIFY `CreateDate` DATETIME NULL,
    MODIFY `LastDate` DATETIME NULL;
...
-- AlterTable
ALTER TABLE `Owner` DROP COLUMN `OwnerFirstname`,
    DROP COLUMN `OwnerLastname`,
    ADD COLUMN `OwnerFirst_name` VARCHAR(100) NOT NULL,
    ADD COLUMN `OwnerLast_name` VARCHAR(100) NOT NULL,
...
-- AlterTable
ALTER TABLE `Shop` MODIFY `CreateDate` DATETIME NULL,
    MODIFY `LastDate` DATETIME NULL;
